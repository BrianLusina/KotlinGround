...
public class Outlier {
    public static void main(String[] args){
        ...
        System.out.printf("Expected:%d Actual: %d", 3, find(exampleTest1));
        System.out.printf("Expected:%d Actual: %d", 206847684, find(exampleTest2));
        System.out.printf("Expected:%d Actual: %d", 0, find(exampleTest3));
    }
