package com.javapp.math.Binary;
 ...
 * Given an array of one's and zero's convert the equivalent java.java.math.Binary.binary value to an integer.
 * <p>
 * Eg: [0, 0, 0, 1] is treated as 0001 which is the java.java.math.Binary.binary representation of 1
 * <p>
 * Examples:
 * <p>
 * Testing: [0, 0, 0, 1] ==> 1
