package main.datastructures.collections.accumulate;
 ...
 * Time: 19:03.
 * Project: java.java.datastructures.collections.accumulate
 */
public class Accumulate {
    ...
    }/*java.java.datastructures.collections.accumulate end*/
    ...
    public static <T> List<T> accumulate_v2(List<T> items, UnaryOperator<T> operation) {
        ...
        return processed;
    }/*java.java.datastructures.collections.accumulate version 2*/
