 ...
 * To account for the rotation, you basically want to find the remainder after dividing it because it's always going
 * to a value between 0 and n, which is where modulus comes in.
 */
