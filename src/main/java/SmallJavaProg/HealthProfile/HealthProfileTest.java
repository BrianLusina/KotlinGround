...
public class HealthProfileTest {
    public static void main(String[] args) {
        ...
        //prompt
        JOptionPane.showMessageDialog(null, "Welcome to the SmallJavaProg.HealthProfile! Enter a few details about yorself and we shall set up your health profile");
        ...
        //create an object of the SmallJavaProg.HealthProfile  class
