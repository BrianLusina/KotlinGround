...
public class HealthProfile
{
	...
	//constructor
	public HealthProfile(String fname,String sname, String userGender,int userDob, double userHeight, double userWeight)
	{
		firstName = fname;
		surname = sname;
		gender = userGender;
	...
	public void BmiTest()
	{
		...
		if(bmi>=30)
			System.out.print("You are obese. You need to work out a lot. Eat right and lead a healthy life! \n");
