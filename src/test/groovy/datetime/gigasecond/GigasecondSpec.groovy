...
class GigasecondSpec extends Specification {
    ...
    def 'calculates one datetime.gigasecond after a date'() {
        given:
    ...
    def 'calculates one datetime.gigasecond after a date with hours and minutes'() {
        given:
    ...
    def 'calculates one datetime.gigasecond after a date with hours and minutes and seconds'() {
        given:
